...
<u>На скриншоте приведены команды и результат выполнения задания по пп. 1-3.</u>  
...
<u>В верхней части каждого скриншота приводятся разные команды и ниже результат их выполнения.</u>  
